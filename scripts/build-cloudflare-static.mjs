...
<html lang="ja">
  <head>
    ...
    <meta name="keywords" content="uwupon, ウワポン, music marketing Japan, Japanese music marketing agency, TikTok music campaign, short-form music marketing, Japan music promotion" />
  ...
  <body>
    ...
    <main>
      <section id="top" class="hero section">
        <div class="wrap hero-grid">
          ...
          <div class="hero-bottom">
            ...
            <p class="intro" data-t="intro">uwupon（ウワポン）は、1曲の魅力が伝わるショート動画を企画・制作し、反応を見ながら広げていく音楽マーケティングスタジオです。</p>
          </div>
        </div>
      </section>
      ...
      <section class="section"><div class="wrap split"><article class="panel black"><h2 data-t="problemTitle">曲を出すだけでは、見つけてもらいにくい時代です。</h2><p class="muted" data-t="problem"></p></article><article class="panel lime"><h2 data-t="answerTitle">uwuponは、曲が届くきっかけを増やします。</h2><p class="muted" data-t="answer"></p></article></div></section>
      ...
      <section class="section dark"><div class="wrap"><h2 data-t="whyTitle">単発投稿で終わらせず、反応を見ながら育てます。</h2><div class="compare"><article class="card"><h2 data-t="traditional">単発プロモーション</h2><ul id="traditionalList"></ul></article><article class="card"><h2 data-t="ours">uwuponの進め方</h2><ul id="oursList"></ul></article></div></div></section>
      ...
      <section class="section"><div class="wrap plans-wrap"><div><h2 data-t="plansTitle">uwuponで相談できること。</h2><p class="muted" data-t="plansNote"></p></div><div class="plans" id="plans"></div></div></section>
    ...
    <script>
      const C = {
        jp: {
          ...
          intro:"uwupon（ウワポン）は、1曲の魅力が伝わるショート動画を企画・制作し、反応を見ながら広げていく音楽マーケティングスタジオです。",
          ...
          answerTitle:"uwuponは、曲が届くきっかけを増やします。", answer:"ショート動画の企画、編集、投稿先の設計、反応を見た改善までまとめて行います。アーティスト本人でも、チームでも、まず相談しやすい形で進められます。",
          ...
          whyTitle:"単発投稿で終わらせず、反応を見ながら育てます。", traditional:"単発プロモーション", ours:"uwuponの進め方", traditionalList:["一度投稿して終わる","見せ方を試しにくい","何が良かったか分かりにくい","短期間で止まりやすい","次のリリースに活かしにくい"], oursList:["複数の切り口を試す","動画本数で接点を増やす","反応を見て改善する","日本向けと海外向けを分けて考える","次のリリースにも使える学びを残す"],
          ecosystemTitle:"1曲から、広がるきっかけを増やす。", ecosystem:[["01","ONE SONG"],["10","CREATIVE DIRECTIONS"],["50+","CONTENT PIECES"],["1000s","DISCOVERY MOMENTS"]],
          plansTitle:"uwuponで相談できること。", plansNote:"個人アーティスト、小規模チーム、レーベル、マネジメントからの相談を歓迎しています。下記は過去実績ではなく、相談時に設計できるキャンペーン例です。再生数や配信先は、楽曲、素材、予算、時期によって変わります。",
          ...
          aboutTitle:"曲が見つかるきっかけを、一緒につくる。", about:"いま音楽は、プレイリストやメディア露出だけで広がるものではありません。ショート動画、編集、クリエイター、コミュニティの中で、曲は何度も新しい意味を持ちます。uwuponは、アーティストやチームと一緒に、楽曲が見つかる入口を増やします。",
        ...
        en: {
          cta:"START A CAMPAIGN", secondary:"SEE HOW IT WORKS", eyebrow:"SHORT-FORM MUSIC STRATEGY FOR JAPAN", hero:["ONE SONG.","CHANGES","EVERYTHING."], intro:"uwupon turns songs into short-form concepts, produces them at volume, distributes them across relevant accounts, then tests and improves the campaign around audience response.",
