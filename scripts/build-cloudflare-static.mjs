  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .en h1 { max-width:none; gap:.04em; font-size:clamp(2.6rem,9.5vw,8.6rem); line-height:.9; text-transform:uppercase; }
  ...
  <body>
    ...
    <script>
      const C = {
        ...
        en: {
          cta:"START A CAMPAIGN", secondary:"SEE HOW IT WORKS", eyebrow:"SHORT-FORM MUSIC STRATEGY FOR JAPAN", hero:["ONE SONG.","MANY WAYS","TO BE FOUND."], intro:"uwupon turns songs into short-form concepts, produces them at volume, distributes them across relevant accounts, then tests and improves the campaign around audience response.",
