...
<html lang="ja">
  ...
  <body>
    ...
    <main>
      <section id="top" class="hero section">
        <div class="wrap hero-grid">
          ...
          <div class="hero-bottom">
            ...
            <p class="intro" data-t="intro">Kyomei（キョウメイ）は、楽曲の魅力が伝わるショート動画を企画・制作し、反応を見ながら広げていく音楽マーケティングスタジオです。</p>
          </div>
        </div>
      </section>
      ...
      <section class="section"><div class="wrap split"><article class="panel black"><h2 data-t="problemTitle">音楽プロモーションは、試せる回数で差がつく。</h2><p class="muted" data-t="problem"></p></article><article class="panel lime"><h2 data-t="answerTitle">Kyomeiは、曲が届くきっかけを増やします。</h2><p class="muted" data-t="answer"></p></article></div></section>
      ...
      <section class="section dark"><div class="wrap"><h2 data-t="whyTitle">ひとつの投稿ではなく、反応が集まる構造をつくる。</h2><div class="compare"><article class="card"><h2 data-t="traditional">従来型の単発施策</h2><ul id="traditionalList"></ul></article><article class="card"><h2 data-t="ours">Kyomeiの運用モデル</h2><ul id="oursList"></ul></article></div></div></section>
      ...
      <section class="section"><div class="wrap plans-wrap"><div><h2 data-t="plansTitle">Kyomeiでできること。</h2><p class="muted" data-t="plansNote"></p></div><div class="plans" id="plans"></div></div></section>
    ...
    <script>
      const C = {
        jp: {
          ...
          intro:"Kyomei（キョウメイ）は、楽曲の魅力が伝わるショート動画を企画・制作し、反応を見ながら広げていく音楽マーケティングスタジオです。",
          ...
          answerTitle:"Kyomeiは、曲が届くきっかけを増やします。", answer:"サビ、歌詞、ムード、ストーリー、編集テンポ、ミーム性、コミュニティの文脈を複数に分解。反応を見ながら、強い企画へ制作と配信を集中させます。",
          ...
          whyTitle:"ひとつの投稿ではなく、反応が集まる構造をつくる。", traditional:"従来型の単発施策", ours:"Kyomeiの運用モデル", traditionalList:["投稿者が限られる","表現の検証が少ない","費用対効果を読みづらい","短期間で終わりやすい","次の施策に学びが残りにくい"], oursList:["複数の企画軸を同時に試す","制作本数で接触機会を増やす","反応を見て改善する","日本語圏と海外圏を分けて設計する","次のリリースに使える知見を残す"],
          ecosystemTitle:"1曲を、コンテンツの生態系へ。", ecosystem:[["01","ONE SONG"],["10","CREATIVE DIRECTIONS"],["50+","CONTENT PIECES"],["1000s","DISCOVERY MOMENTS"]],
          plansTitle:"Kyomeiでできること。", plansNote:"過去実績ではなく、相談時に設計できるキャンペーン例です。再生数、配信面、ストリーム増加は楽曲、素材、予算、投稿先、時期により変動します。",
          ...
          aboutTitle:"広告ではなく、インターネットが使いたくなる理由をつくる。", about:"いま音楽は、プレイリストやメディア露出だけで広がるものではありません。ショート動画、編集、クリエイター、コミュニティの中で、曲は何度も新しい意味を持ちます。Kyomeiは、その流れに合わせて、楽曲が見つかる入口を増やします。",
