...
<html lang="ja">
  <head>
    ...
    <title>Kyomei | 日本発ショートフォーム音楽マーケティング</title>
    <meta name="description" content="Kyomei is a Tokyo-based short-form music marketing studio for artists, labels, management teams, and Japan-global music releases." />
    <meta name="keywords" content="Kyomei, キョウメイ, music marketing Japan, Japanese music marketing agency, TikTok music campaign, short-form music marketing, Japan music promotion" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="ja_JP" />
    <meta property="og:site_name" content="Kyomei" />
    <meta property="og:title" content="Kyomei | Short-Form Music Marketing for Japan" />
    ...
    <meta name="twitter:title" content="Kyomei | Short-Form Music Marketing for Japan" />
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .hero-grid { position:relative; display:grid; grid-template-columns:minmax(0,.9fr) minmax(460px,.82fr); gap:32px; align-items:start; min-height:calc(100vh - 150px); align-content:space-between; }
      ...
      .en .hero-grid { grid-template-columns:minmax(0,.95fr) minmax(500px,.82fr); }
      .en h1 { max-width:none; gap:.04em; font-size:clamp(2.6rem,8.3vw,7.5rem); line-height:.9; text-transform:uppercase; }
      .en h1 span { white-space:nowrap; }
      .hero-img { position:relative; overflow:hidden; border:1px solid #0003; background:#000; box-shadow:0 24px 80px #0005; margin-top:20px; min-height:360px; }
      .hero-img img { display:block; width:100%; height:100%; min-height:260px; object-fit:cover; opacity:.9; }
      ...
      @media (max-width: 1180px) {
        ...
        .hero-img { margin-top:0; min-height:0; }
        .hero-img img { aspect-ratio:16/10; height:auto; }
      }
  ...
  <body>
    <nav class="nav">
      <a class="brand" href="#top"><span class="mark"><span class="dot"></span></span><span>Kyomei</span></a>
      <div class="navlinks">
    ...
    <main>
      <section id="top" class="hero section">
        <div class="wrap hero-grid">
          ...
          <div class="hero-img"><img src="/og.png" alt="Kyomei short-form music content ecosystem visual" /><div class="hero-caption"><span>Release Signal Map</span><b>50+</b></div></div>
          <div class="hero-bottom">
            ...
            <p class="intro" data-t="intro">Kyomei（キョウメイ）は、1曲の魅力が伝わるショート動画を企画・制作し、反応を見ながら広げていく音楽マーケティングスタジオです。</p>
          </div>
        </div>
      </section>
      <section id="work" class="section dark"><div class="wrap"><div class="proof"><div><h2 data-t="proofTitle">個人アーティストから、レーベルやマネジメントまで。</h2><p class="muted" data-t="proofCopy">本人からの直接相談、小規模チームでのリリース、レーベルや事務所のプロモーションまで対応します。難しいマーケティング用語よりも、まずは曲をどう届けるかを一緒に整理します。</p></div><div class="tile-grid" id="audience"></div></div><div class="stats" id="stats"></div></div></section>
      <section class="section"><div class="wrap split"><article class="panel black"><h2 data-t="problemTitle">曲を出すだけでは、見つけてもらいにくい時代です。</h2><p class="muted" data-t="problem"></p></article><article class="panel lime"><h2 data-t="answerTitle">Kyomeiは、曲が届くきっかけを増やします。</h2><p class="muted" data-t="answer"></p></article></div></section>
      <section id="how-it-works" class="section"><div class="wrap model"><div><p class="eyebrow">The Model</p><h2 data-t="modelTitle">1曲を、いくつもの届け方へ。</h2><p class="muted" data-t="modelCopy"></p></div><div class="steps" id="steps"></div></div></section>
      <section id="services" class="section" style="background:white"><div class="wrap"><h2 data-t="servicesTitle">曲を広げるために、必要なことをまとめて支援します。</h2><div class="services" id="servicesGrid"></div></div></section>
      <section class="section dark"><div class="wrap"><h2 data-t="whyTitle">単発投稿で終わらせず、反応を見ながら育てます。</h2><div class="compare"><article class="card"><h2 data-t="traditional">単発プロモーション</h2><ul id="traditionalList"></ul></article><article class="card"><h2 data-t="ours">Kyomeiの進め方</h2><ul id="oursList"></ul></article></div></div></section>
      <section class="section ecosystem"><div class="wrap"><h2 data-t="ecosystemTitle">1曲から、広がるきっかけを増やす。</h2><div class="eco" id="ecosystem"></div></div></section>
      <section class="section"><div class="wrap plans-wrap"><div><h2 data-t="plansTitle">Kyomeiで相談できること。</h2><p class="muted" data-t="plansNote"></p></div><div class="plans" id="plans"></div></div></section>
      <section id="about" class="section" style="background:white"><div class="wrap about"><h2 data-t="aboutTitle">曲が見つかるきっかけを、一緒につくる。</h2><p class="intro" data-t="about"></p></div></section>
      <section id="contact" class="section dark"><div class="wrap contact"><div><p class="eyebrow" style="color:var(--lime)">Contact</p><h2 data-t="formTitle">次のリリースを相談する。</h2><p class="muted" data-t="formIntro"></p></div><form action="https://formsubmit.co/aweandco@gmail.com" method="POST" id="leadForm" novalidate><input type="hidden" name="_subject" value="New Kyomei campaign inquiry" /><input type="hidden" name="_template" value="table" /><input type="hidden" name="_captcha" value="false" /><input type="hidden" name="_next" value="/?sent=1" /><input type="text" name="_honey" style="display:none" tabindex="-1" autocomplete="off" /><div class="form-grid" id="fields"></div><label><span data-field-label="goal">キャンペーン目標</span><input name="campaign_goal" data-field="goal" placeholder="認知拡大、UGC、海外展開、発売週の話題化など" /></label><label><span data-field-label="info">追加情報</span><textarea name="additional_information" data-field="info" placeholder="素材状況、SNS状況、締切、参考キャンペーンなど"></textarea></label><button class="btn-lime" type="submit" data-t="cta">キャンペーンを相談する</button><p class="success" id="success" hidden data-t="success">ありがとうございます。お問い合わせを受け付けました。</p></form></div></section>
      <section class="section"><div class="wrap legal"><div><p class="eyebrow" data-t="legalTitle">Legal</p><h3>Kyomei</h3><p class="muted" data-t="footer">Tokyo, Japan</p></div><article><h3 data-t="privacyTitle">プライバシーポリシー</h3><p class="muted" data-t="privacy"></p></article><article><h3 data-t="termsTitle">利用条件</h3><p class="muted" data-t="terms"></p></article></div><div class="wrap footer"><p class="eyebrow">Copyright 2026 Kyomei. All rights reserved.</p><span class="toggle"><button data-lang="jp" class="active">JP</button><button data-lang="en">EN</button></span></div></section>
    </main>
    ...
    <script>
      const C = {
        jp: {
          ...
          intro:"Kyomei（キョウメイ）は、1曲の魅力が伝わるショート動画を企画・制作し、反応を見ながら広げていく音楽マーケティングスタジオです。",
          proofTitle:"個人アーティストから、レーベルやマネジメントまで。", proofCopy:"本人からの直接相談、小規模チームでのリリース、レーベルや事務所のプロモーションまで対応します。難しいマーケティング用語よりも、まずは曲をどう届けるかを一緒に整理します。",
          audience:["個人アーティスト","小規模チーム","マネジメント","レーベル","音楽事務所","日本 / 海外"], stats:[["3","主要ショートフォーム面"],["50+","1曲から設計できる動画案"],["7","戦略からレポートまでの工程"]],
          problemTitle:"曲を出すだけでは、見つけてもらいにくい時代です。", problem:"一度だけ投稿して終わりでは、どんな見せ方が合うのか分かりにくいものです。サビ、歌詞、雰囲気、本人の映像など、いくつかの切り口を試すことで、曲が届く可能性を広げます。",
          answerTitle:"Kyomeiは、曲が届くきっかけを増やします。", answer:"ショート動画の企画、編集、投稿先の設計、反応を見た改善までまとめて行います。アーティスト本人でも、チームでも、まず相談しやすい形で進められます。",
          modelTitle:"1曲を、いくつもの届け方へ。", modelCopy:"曲の魅力をひとつの広告に閉じ込めず、ショート動画で伝わりやすい形に分けて試します。流れはシンプルに、改善は丁寧に。",
          ...
          servicesTitle:"曲を広げるために、必要なことをまとめて支援します。", services:[["ショート動画企画","TikTok、Reels、Shortsで伝わりやすい曲の見せ方を考えます。"],["見せ方の整理","サビ、歌詞、雰囲気、本人素材など、どこを入口にするかを一緒に決めます。"],["動画制作","広告っぽく見えすぎない、自然に見られる短尺動画を複数パターン制作します。"],["配信設計","曲と相性の良い投稿面やアカウントを選び、無理のない形で広げます。"],["改善","再生数、保存、コメントなどの反応を見ながら、次に作る動画を調整します。"],["レポート","何が反応されたのか、次に何をすべきかを分かりやすく整理します。"],["日本 / 海外","日本の曲を海外へ、海外の曲を日本へ届けるための見せ方も相談できます。"]],
          whyTitle:"単発投稿で終わらせず、反応を見ながら育てます。", traditional:"単発プロモーション", ours:"Kyomeiの進め方", traditionalList:["一度投稿して終わる","見せ方を試しにくい","何が良かったか分かりにくい","短期間で止まりやすい","次のリリースに活かしにくい"], oursList:["複数の切り口を試す","動画本数で接点を増やす","反応を見て改善する","日本向けと海外向けを分けて考える","次のリリースにも使える学びを残す"],
          ecosystemTitle:"1曲から、広がるきっかけを増やす。", ecosystem:[["01","ONE SONG"],["10","CREATIVE DIRECTIONS"],["50+","CONTENT PIECES"],["1000s","DISCOVERY MOMENTS"]],
          plansTitle:"Kyomeiで相談できること。", plansNote:"個人アーティスト、小規模チーム、レーベル、マネジメントからの相談を歓迎しています。下記は過去実績ではなく、相談時に設計できるキャンペーン例です。再生数や配信先は、楽曲、素材、予算、時期によって変わります。",
          ...
          aboutTitle:"曲が見つかるきっかけを、一緒につくる。", about:"いま音楽は、プレイリストやメディア露出だけで広がるものではありません。ショート動画、編集、クリエイター、コミュニティの中で、曲は何度も新しい意味を持ちます。Kyomeiは、アーティストやチームと一緒に、楽曲が見つかる入口を増やします。",
          formTitle:"次のリリースを相談する。", formIntro:"アーティスト本人からの直接相談も歓迎しています。楽曲、発売日、届けたい市場、予算感を共有してください。確認後、進め方を整理してご連絡します。",
          fields:{name:"氏名",company:"所属 / チーム",email:"メールアドレス",artist:"アーティスト",project:"楽曲 / プロジェクト",budget:"キャンペーン予算",market:"ターゲット市場",release_date:"リリース日",goal:"キャンペーン目標",info:"追加情報"}, success:"ありがとうございます。お問い合わせを受け付けました。",
        ...
        en: {
          cta:"START A CAMPAIGN", secondary:"SEE HOW IT WORKS", eyebrow:"SHORT-FORM MUSIC STRATEGY FOR JAPAN", hero:["ONE SONG.","CHANGES","EVERYTHING."], intro:"Kyomei turns songs into short-form concepts, produces them at volume, distributes them across relevant accounts, then tests and improves the campaign around audience response.",
          ...
          whyTitle:"Not one post. A structure for more signal.", traditional:"Traditional one-off promotion", ours:"Kyomei operating model", traditionalList:["Limited creators","Few creative tests","Hard-to-read efficiency","Short campaign life","Little learning for the next release"], oursList:["Multiple creative directions","Higher content volume","Continuous optimization","Separate Japan and global angles","Reusable learning for future releases"],
          ...
          legalTitle:"Legal", footer:"Tokyo, Japan", privacyTitle:"Privacy Policy", privacy:"Information submitted through the contact form, including name, company, email address, artist, and project details, is used only to respond to inquiries, prepare proposals, communicate about services, and improve operations. We do not sell submitted personal information to third parties.", termsTitle:"Terms", terms:"This website provides general information about Kyomei services. Campaign scope, fees, timing, deliverables, and performance indicators are determined by individual agreement. Unauthorized copying, redistribution, or commercial use of site content is prohibited."
        }
      };
